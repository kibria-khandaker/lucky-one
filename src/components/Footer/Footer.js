    ...
    return (
        <div className='footer_section'>
            ...
            <div className='question_text'>
                ...
                <b>Answer:</b>
                <p>
                React একটি জাভাস্ক্রিপ্ট মুলত একটা লাইব্রেরি এবং এটা মুলত ইউজার ইন্টারফেস তৈরির জন্য কাজ করে থাকে । রেন্ডার এর সময়  useEffect, useState,Component কে DOM পাঠায় এবং  React এর কম্পনেন্ট এ Jsx এ ফাইলে HTML  ও JS লিখে এটা কে থেকে নিয়ে React virtual DOM ও HTML DOM এর সাহাজ্যে ইউজারের জন্যে একটা ভিউ তৈরী করে। React একটি ভার্চুয়াল DOM এর দিয়ে যা মূলত জাভাস্ক্রিপ্টে একটি DOM তৈরী করে। 
